...
lf_bg = 'Green' # bg color for the left_frame
cf_bg = 'Brown' # bg color for the center_frame
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg='Black').pack(side=TOP, fill=X)
...
Label(left_frame, text="Stream", font=labelfont, bg=lf_bg).place(relx=0.4, rely=0.7)
...
dob = DateEntry(left_frame, font=("Arial", 10), width=12)
dob.place(x=20, rely=0.62)

Button(left_frame, text='Add Record', font=labelfont, command=add_record, width=12).place(relx=0.035, rely=0.85)
